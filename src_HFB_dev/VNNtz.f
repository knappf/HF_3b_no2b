      double precision function VNNtz(i,j,k,l,Jp)
       ...
       if(levtz(i)%tz.eq.-1.and.levtz(j)%tz.eq.-1) then
        if(levtz(k)%tz.eq.-1.and.levtz(l)%tz.eq.-1) then
         VNNtz=Vpp_me(levtz(i)%point,levtz(j)%point,
     &                            levtz(k)%point,levtz(l)%point,Jp)
       ...
       if(levtz(i)%tz.eq.1.and.levtz(j)%tz.eq.1) then
        if(levtz(k)%tz.eq.1.and.levtz(l)%tz.eq.1) then
         VNNtz=Vnn_me(levtz(i)%point,levtz(j)%point,
     &                            levtz(k)%point,levtz(l)%point,Jp)
        endif
       endif
       ...
       if(levtz(i)%tz.eq.-1.and.levtz(j)%tz.eq.1) then
        if(levtz(k)%tz.eq.-1.and.levtz(l)%tz.eq.1) then
         VNNtz=Vpn_me(levtz(i)%point,levtz(j)%point,
     &                            levtz(k)%point,levtz(l)%point,Jp)
        endif
       endif
       if(levtz(i)%tz.eq.1.and.levtz(j)%tz.eq.-1) then
        if(levtz(k)%tz.eq.1.and.levtz(l)%tz.eq.-1) then
         VNNtz=Vpn_me(levtz(j)%point,levtz(i)%point,
