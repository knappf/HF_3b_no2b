...
!!!    Substitution needed for resticted model space
       
!!!       allocate(levp(id),levn(id))
!!!       allocate(lhfp(id),lhfn(id))
!!!       allocate(lev1pn(id),lp1(id),lp2(id))

       allocate(levp(id_file),levn(id_file))
       allocate(lhfp(id_file),lhfn(id_file))
       allocate(lev1pn(id_file),lp1(id_file),lp2(id_file))
...
!!!       allocate(lpoint(id,id,id,0:jmax,0:1,3))
       allocate(lpoint(id_file,id_file,id_file,0:jmax,0:1,3))
       lpoint=0
...
!!!       allocate(klpoi1(id,id))
       allocate(klpoi1(id_file,id_file))
       itpoi1=0
       klpoi1=0
