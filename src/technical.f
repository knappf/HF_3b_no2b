     ...
     &            idim_v3b,ipozjt1,ipozt1
        ...
        real(kind=4), ALLOCATABLE, SAVE :: Vpp(:,:,:,:,:)
        real(kind=4), ALLOCATABLE, SAVE :: Vnn(:,:,:,:,:)
        real(kind=4), ALLOCATABLE, SAVE :: Vpn(:,:,:,:,:)
...
!     This array is only here for testing
!     real(kind=4), ALLOCATABLE, SAVE :: V3B_ar2(:)
